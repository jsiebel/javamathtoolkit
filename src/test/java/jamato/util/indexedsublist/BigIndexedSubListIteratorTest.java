...
class BigIndexedSubListIteratorTest {
	...
	static Stream<Arguments> hasNextTest() {
		return Stream.of(
				arguments(List.of("a", "b", "c"), new long[] { 0b101 }, 0, true),
				arguments(List.of("a", "b", "c"), new long[] { 0b101 }, 1, true),
				arguments(List.of("a", "b", "c"), new long[] { 0b101 }, 2, false),
				arguments(List.of(), new long[] { }, 0, false),
				arguments(List.of("a", "b", "c", "d"), new long[] { 0b0000 }, 0, false),
				arguments(listOfSize(256), new long[] { 0, 4, 0, 4 }, 0, true),
				arguments(listOfSize(256), new long[] { 0, 4, 0, 4 }, 1, true),
				arguments(listOfSize(256), new long[] { 0, 4, 0, 4 }, 2, false));
	}
	...
	static Stream<Arguments> hasPreviousTest() {
		return Stream.of(
				arguments(List.of("a", "b", "c"), new long[] { 0b101 }, 0, false),
				arguments(List.of("a", "b", "c"), new long[] { 0b101 }, 1, true),
				arguments(List.of(), new long[] { 0b0 }, 0, false),
				arguments(List.of("a", "b", "c", "d"), new long[] { 0b0000 }, 0, false),
				arguments(listOfSize(256), new long[] { 0, 4, 0, 4 }, 0, false),
				arguments(listOfSize(256), new long[] { 0, 4, 0, 4 }, 1, true),
				arguments(listOfSize(256), new long[] { 0, 4, 0, 4 }, 2, true));
	}
	...
	static Stream<Arguments> navigationTest() {
		return Stream.of(
				arguments(List.of("a", "b", "c", "d"), new long[] { 0b101 }, 0, "a", "c"),
				arguments(List.of("a", "b", "c", "d"), new long[] { 0b1101 }, 1, "c", "d"),
				arguments(listOfSize(256), new long[] { 0b100, 0, 0, 0b100000, 0 }, 0, "0,2", "3,5"));
	}
	...
	static Stream<Arguments> nextExceptionTest() {
		return Stream.of(
				arguments(List.of(), new long[] { 0b0 }, 0),
				arguments(List.of("a", "b", "c"), new long[] { 0b101 }, 2),
				arguments(listOfSize(256), new long[] { 0, 4, 0, 4 }, 2));
	}
	...
	static Stream<Arguments> previousExceptionTest() {
		return Stream.of(
				arguments(List.of(), new long[] { 0b0 }, 0),
				arguments(List.of("a", "b", "c"), new long[] { 0b101 }, 0),
				arguments(listOfSize(256), new long[] { 0, 4, 0, 4 }, 0));
	}
	...
	static Stream<Arguments> testNextIndex() {
		return Stream.of(
				Arguments.of(List.of("a", "b", "c", "d", "e"), new long[] { 0b11110 }, 0, 0),
				Arguments.of(List.of("a", "b", "c", "d", "e"), new long[] { 0b11110 }, 1, 1),
				Arguments.of(List.of("a", "b", "c", "d", "e"), new long[] { 0b10110 }, 2, 2),
				Arguments.of(List.of("a", "b", "c", "d", "e"), new long[] { 0b10110 }, 3, 3));
	}
	...
	static Stream<Arguments> testPreviousIndex() {
		return Stream.of(
				Arguments.of(List.of("a", "b", "c", "d", "e"), new long[] {0b11110}, 1, 0),
				Arguments.of(List.of("a", "b", "c", "d", "e"), new long[] {0b10110}, 2, 1),
				Arguments.of(List.of("a", "b", "c", "d", "e"), new long[] {0b10110}, 3, 2));
	}
	
	private static List<?> listOfSize(int size) {
		return IntStream.range(0, size).mapToObj(i -> (i / 64) + "," + (i % 64)).toList();
	}
}
